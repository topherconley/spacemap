...
Color the nodes according to their communities and since this community detection method is hierarchical, we can further group higher order structure of the communities with shaded polygons. Edges between communities are colored red and edges  
